  ...
  class BasicTypeRegistry
    ...
    class CoderMap
      ...
      def initialize(result, coders_by_name, format, arraycoder)
        ...
        @coders_by_name = @coders.each_with_object({}) do |t, h|
          h[t.name] = t
        end
        @coders_by_oid = @coders.each_with_object({}) do |t, h|
          h[t.oid] = t
        end
      end

      attr_reader :coders, :coders_by_oid, :coders_by_name
    ...
    def alias_type(format, new, old)
      %i[encoder decoder].each do |ende|
